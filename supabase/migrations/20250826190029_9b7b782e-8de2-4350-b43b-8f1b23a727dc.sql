-- First, set all existing penalties to have null penalty_type_id to remove the foreign key constraint
UPDATE penalties SET penalty_type_id = NULL WHERE penalty_type_id IS NOT NULL;

-- Now clear existing penalty catalog data
